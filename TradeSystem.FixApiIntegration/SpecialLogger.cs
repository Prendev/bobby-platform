...
namespace TradeSystem.FixApiIntegration
{
	public static class SpecialLogger
	{
		public static void Log(Connector connector, ExecutionReportEventArgs e)
		{
			...
			Logger.Debug($"\t{connector.Description}\t{e.ExecutionReport.Symbol}\t{e.ExecutionReport.OrderType}\t{e.ExecutionReport.Side}\t{e.ExecutionReport.FulfilledQuantity}\t{e.ExecutionReport.FulfilledPrice}");
		}
	}
}
