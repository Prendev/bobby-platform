    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.FixTraderAccounts", t => t.FtAccountId, cascadeDelete: true)
                .ForeignKey("dbo.MetaTraderAccounts", t => t.MtAccountId, cascadeDelete: true)
                .ForeignKey("dbo.Profiles", t => t.ProfileId, cascadeDelete: true)
                .Index(t => t.ProfileId)
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        ProfileId = c.Int(nullable: false),
                        MainMetaTraderAccountId = c.Int(),
                        MainFixTraderAccountId = c.Int(),
                        MainSymbol = c.String(),
                        PairMetaTraderAccountId = c.Int(),
                        PairFixTraderAccountId = c.Int(),
                        PairSymbol = c.String(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.FixTraderAccounts", t => t.MainFixTraderAccountId)
                .ForeignKey("dbo.MetaTraderAccounts", t => t.MainMetaTraderAccountId)
                .ForeignKey("dbo.FixTraderAccounts", t => t.PairFixTraderAccountId)
                .ForeignKey("dbo.MetaTraderAccounts", t => t.PairMetaTraderAccountId)
                .ForeignKey("dbo.Profiles", t => t.ProfileId, cascadeDelete: true)
                .Index(t => t.ProfileId)
                .Index(t => t.MainMetaTraderAccountId)
                .Index(t => t.MainFixTraderAccountId)
                .Index(t => t.PairMetaTraderAccountId)
                .Index(t => t.PairFixTraderAccountId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.StratDealingArbs", "MtAccountId", "dbo.MetaTraderAccounts");
            DropForeignKey("dbo.StratDealingArbs", "FtAccountId", "dbo.FixTraderAccounts");
